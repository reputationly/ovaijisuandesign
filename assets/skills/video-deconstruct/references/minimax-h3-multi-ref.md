...
- 对白与旁白保持批准文本和原始语言；视觉描述按所选模型的语言约定编写。
...
- 生成路线、参考数量、时长、分辨率和音频设置全部按最新能力摘要与 MiniMax H3 能力说明校验。
...
Semantic Judgment 管贡献取舍，运行计划管 refs / work items / 执行策略，MiniMax H3 能力说明管工程事实。本文件不维护固定设置表、固定质量档、批次协议、旧 agent 分工或硬门。
